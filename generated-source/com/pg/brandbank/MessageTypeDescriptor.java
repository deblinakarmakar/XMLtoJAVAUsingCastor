...
public class MessageTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MessageTypeDescriptor() 
     {
        ...
        //-- _dateTime
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.util.Date.class, "_dateTime", "DateTime", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    MessageType target = (MessageType) object;
                    target.setDateTime( (java.util.Date) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.pg.brandbank.MessageTypeDescriptor()
    ...
    {
        return com.pg.brandbank.MessageType.class;
